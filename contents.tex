...
changes three times (thus left endpoints, right endpoints, left endpoints, and right endpoints).
...
This bound is super-exponential: when $b_i=c_i=1$ for all $i$\idest for the bracket expression
$\langle^a\rangle\langle\dotsb\rangle\langle\rangle^a$,
...
and, of course, the \emph{On-Line Encyclopedia of Integer Sequences}, and \emph{Mathematica}.
