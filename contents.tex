...
It is a well-known result, shown\footnote{D.~Tamari showed that there were as many well-formed bracket
expressions with $n$ parentheses as there are correct parenthesizings of $n+1$ factors. In turn,
E.~C.~Catalan had shown in 1838 \citep{Catalan1838} that the recurrence (\ref{CatalanRecurrence}) counts
