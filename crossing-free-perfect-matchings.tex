...
\marginfig[TODO description\label{figTrapezoids}]{
\begin{tikzpicture}[scale=0.6]
\tikzstyle{dot}=[draw,shape=circle,fill=black,scale=0.5]
\tikzstyle{wdot}=[draw,shape=circle,fill=white,scale=0.5]

\draw[very thick, name path=V] (0,5) -- (0,-1);
\draw[very thick, name path=W] (4,5) -- (4,-1);
...
\node[dot] at (-1.4,3) (a3) {};
\node[dot] at (-1.5,2.5) (a4) {};
\node[wdot] at (-1,2) (a5) {};
\node[dot] at (-1.3,1.5) (a6) {};
\node[wdot] at (-2.2,1) (a7) {};

\node[dot] at (2,4.2) (b1) {};
\node[dot] at (1.8,3.1) (b3) {};
\node[dot] at (2.2,2.3) (b4) {};
\node[dot] at (1.9,1.6) (b6) {};

\node[dot] at (3,1.3) (c) {};

\node[wdot] at (4.5,3.8) (d2) {};
\node[wdot] at (5,1.9) (d5) {};
\node[wdot] at (4.25,0.8) (d7) {};
\node[dot] at (5.25,1) (dc) {};
