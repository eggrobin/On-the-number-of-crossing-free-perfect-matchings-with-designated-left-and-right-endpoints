...
Thus for every point $p$, we consider it at some point as the leftmost point of some $S_p$, and we
choose which points of $S_p$ are above and which points are below the segment $a_p$ of $p$.
...
of $S_p$ in polar order around $p$, or delimited by the ray passing through the first or last point
of $S_p$ in polar order and the vertical. Thus a crossing-free aligment has all its segments constrained
...
[TODO bon là il va faloir que je nomme les sous-ensembles de points qui interviennent dans
