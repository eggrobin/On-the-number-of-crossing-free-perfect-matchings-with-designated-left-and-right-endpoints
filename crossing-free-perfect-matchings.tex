...
\leq \gP_1\of{a+b}\gP_2\of{a+b} f_1\of{a,z}f_2\of{b,z}\text.\]
...
\subsection{Improving upon the binomial bound}\label{ImprovingBinomial}
...
\subsection{A better recurrence, and a solution}
...
We conclude this work by highlighting a way in which the bound from section~\ref{sectionThreeChanges}
