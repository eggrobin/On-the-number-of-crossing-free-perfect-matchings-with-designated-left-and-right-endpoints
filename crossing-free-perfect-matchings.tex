...
This proof is due to A.~J.~Ruiz-Vargas and E.~Welzl [TODO cite paper to appear, is there a preprint?].
...
If this procedure did not terminate, it would yield a sequence $\gm$ of crossing perfect matchings on $P$ on
...
$\BigO\of{n^3}$ steps by J.~van~Leeuwen and A.~A.~Schoone in 1980.}
find a
...
[TODO internal reference; the proof and citation will be in the section on convex point sets.]
