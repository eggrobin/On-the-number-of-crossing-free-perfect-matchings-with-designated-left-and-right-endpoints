...
Let us first take another look at the anatomy of a crossing-free left-aligment.
Given a crossing-free left alignment $\gl$ of $L$, with $l$ the leftmost point of $L$,
we shall call the set of points $p\in L$ such that $\gl\of p < \gl\of l$ the points
\emph{above} $l$, and the points $p\in L$ such that $\gl\of p > \gl\of l$ the points
\emph{below} $l$. Recall that $\gl$ defines a crossing-free left-alignment of the points
above and $l$ as well as a crossing-free left alignment of the points below $l$.


 Recall that we iteratively
...
[TODO bon la il va faloir que je nomme les sous-ensembles de points qui interviennent dans
la construction des alignements, sinon je suis pas sorti de l'auberge]
