...
\gn_{\pointset P}\of B\preccurlyeq_{\Cardinality{\pointset P} = n}5.3793^n
\]
...
\preccurlyeq_{\Cardinality{\pointset P} = n} \CatalanNumber {\frac n 2} 5.3793^n
...
$\gl(l)$, being the index on the vertical line $V$ of the right endpoint of the segment $\gs_{\leftmost\pointset S}$
...
otherwise they would cross $\gs_l$, and correspondingly for
