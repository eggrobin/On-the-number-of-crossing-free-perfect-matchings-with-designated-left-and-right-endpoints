...
\end{scope}
\end{tikzpicture}}
\marginfig[A crossing-free perfect matching across a line $\gm$.
...
\node[dot] at (-.5,4.5) (a1) {};
\node[dot] at (-1,3.5) (a3) {};
\node[dot,label=below:$\leftmost\pointset L$] at (-4,3) (a4) {};
\node[dot] at (-1.3,2) (a6) {};
...
\end{scope}
\end{tikzpicture}}
Recall that a crossing-free left-alignment $\gl$ is determined by the value of $\gl\of{\leftmost L}$ and by
crossing-free left alignments
of the points above and below any edge realizing $\gl$\idest above and below $\lcone{\gl\of{\leftmost L}}$.
...
\item $\gl^-$ be the crossing-free left-alignment of the points above
\end{enumerate}
This is equivalent to choosing left $\pointset L$-cone number $\gl\of{\leftmost L}$,
