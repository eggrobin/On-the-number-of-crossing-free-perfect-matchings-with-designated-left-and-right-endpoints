...
track of the growth due to $z$; we will thus write that\[
u \of {n,z} \preccurlyeq_n f \of {n,z} \text{ \emph{uniformly in $z\in\gW_n$}}\]
if for some polynomial $p$ (that does not depend on $z$),
$\forall n\in \N,\forall z \in \gW_n, u\of {n,z} \leq p\of n f \of {n,z}$.
If $f \of {n,z}$ then admits a supremum $\bar f \of {n}$ in $z\in\gW_n$ for all $n$, this implies
...
g_z \of {\pointset P} \leq u \of {n, z}\]
...
\begin{equation}
C_n \sim \frac{4^n}{n^{\frac{3}{2}}\sqrt{\Pi}} \preccurlyeq_n 4^n\text.
\end{equation}
...
First, we note that $\spc\of{a,a} = C_k$: there is only one summand, $S'$ is the whole set, so
...
\spc\of{a,a} &= C_a \label{spckk}\text.
...
&= \sum{i=0}[b]
C_{i}\spc\of{a-i-2,b-i}
+\sum{i=0}[b]C_{i}\spc\of{a-i-1,b-i-1} \nonumber \\
&= \sum{i=0}[b]
C_{i}\spc\of{(a-1)-i-1,b-i}
+\sum{i=0}[b-1]C_{i}\spc\of{a-i-1,(b-1)-i} \\&\phantom{=}\qquad + C_{b}\spc\of{a-b-1,-1}\text, \nonumber \\
...
C_{\frac{k}{\gh + 1}} \binom{k}{\frac{k}{\gh + 1}} \frac{k-k\gh+\gh+1}{k+\gh+1}
\leq C_{\frac{k}{\gh + 1}} \binom{k}{\frac{k}{\gh + 1}}\text.
\]
