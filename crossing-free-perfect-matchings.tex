...
We can now turn this recurrence into a simpler and better-known one.
...
In addition to that, we also let $\spc\of{a,b} = 0$ when $b > a$.

Note that for $a - 1 = b\geq 0$, we have\begin{align}
\spc\of{a, b}
= \sum{i=0}[l]C_{i}\spc\of{a-i-1,l-i} = \sum{i=0}[l]C_{i}\spc\of{b-i,b-i} 
