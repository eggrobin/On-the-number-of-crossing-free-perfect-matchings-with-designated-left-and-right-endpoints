...
point sets.
\marginfig[TODO\label{figCellsOnALine}]{
\begin{tikzpicture}[scale=0.6]
\tikzstyle{dot}=[draw,shape=circle,fill=black,scale=0.5]
\tikzstyle{wdot}=[draw,shape=circle,fill=white,scale=0.5]
...
\node[label={[font=\scriptsize,label distance=-5pt]above left:$2$}] at (align) {};
...
\node[label={[font=\scriptsize,label distance=-5pt]below left:$5$}] at (align) {};
...
\node[label={[font=\scriptsize,label distance=-5pt]below left:$7$}] at (align) {};
