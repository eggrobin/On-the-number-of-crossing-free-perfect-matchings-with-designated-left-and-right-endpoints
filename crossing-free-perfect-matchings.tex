...
For spanning cycles, the question was introduced by M.~Newborn and W.~O.~J.~Moser in 1976 [CITE], and a
super-exponential upper bound was given.
In 1980, M.~Ajtai, V.~Chvátal, M.~Newborn, and E.~Szemerédi [CITE] proved that there are only exponentially many
...
the numbers of crossing-free perfect matchings, triangulations, and spanning cycles are known.

For perfect matchings, an optimal lower bound of $C_{\frac n 2}$ was obtained as early as 1995 by A.~García,
M.~Noy, and J.~Tejel [CITE]; upper bounds have been harder to come by, with the best one yet being asymptotically
$10.05^n$, given by M.~Sharir and E.~Welzl in 2005 [CITE].
In that same work, an upper bound of $5.83^n$ are given for the number of crossing-free perfect matchings on a
