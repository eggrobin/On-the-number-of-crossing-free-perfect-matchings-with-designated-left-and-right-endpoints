...
The following result, and its proof, were given by Micha Sharir and Emo Welzl in 2006 [TODO cite].
\NoEndMark
...
the left-points to the right-points. Consider such a matching, and let $E$ be its set of edges.
...
\begin{lemma}
There are at most $C_k$ crossing-free left-alignments of $k$ points on a given line.
\begin{proof}
...
Letting $i\DefineAs \gl\of l - 1$, these are crossing-free alignments of $i$ and $k-i-1$ points.
