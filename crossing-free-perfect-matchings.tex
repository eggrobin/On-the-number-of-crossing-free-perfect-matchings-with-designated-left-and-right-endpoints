...
Given a set of points $L$ in general position with respect to the horizontal and a nonempty set of points $R$
...
by rays emanating from $L_1$ and going through other points of $L$. We will call those regions \emph{cones},
and number them from top to bottom from $1$ to $\Cardinality L$, see figure~\ref{figCones}.
